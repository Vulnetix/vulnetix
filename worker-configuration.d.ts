// Generated by Wrangler by running `wrangler types` (hash: e8fcbda238212a863e43af452bdcfbc8)
// Runtime types generated with workerd@1.20250321.0 2024-03-20 nodejs_compat
export {};
declare global {
	const GITHUB_APP_ID: string;
	const GITHUB_APP_CLIENT_ID: string;
	const GITHUB_APP_CLIENT_SECRET: string;
	const GITHUB_WEBHOOK_SECRET: string;
	const CLOUDFLARE_API_TOKEN: string;
	const LOG_LEVEL: string;
	const APP_PRIVATE_KEY: string;
	const r2artifacts: R2Bucket;
	const r2webhooks: R2Bucket;
